...
INSERT INTO "BAER_TI"."TBLANIMALSPECIESDETAIL" (ID, CHARACTERISTICS, VITA, HABITAT, TBLANIMALSPECIES_ID, ISTHREATENED, ISEEP) VALUES ('1000', 'Weltweit in Unterarten in tropischen und gemäßigten Zonen verbreitet. Etwa 60cm groß und bis 800g schwer. Lebensraum stets in Wassernähe. Geschlechter gleich gefärbt.', 'Koloniebrüter. In einigen Regionen Annsammlungen bis 2500 Nester und 5000-6000 Nester in Malysia. Erbeutet Insekten, Spinnen, Mollusken, Amphibien, Reptilien, Fische und Kleinsäuger. 3-5 Eier, die überwiegend vom Weibchen etwa 25 Tage bebrütet werden. Junge mit 6 Wochen selbständig.', 'Amerika, Afrika, Eurasien', '1000', '0', '0');
...
INSERT INTO "BAER_TI"."TBLANIMALSPECIESDETAIL" (ID, CHARACTERISTICS, VITA, HABITAT, TBLANIMALSPECIES_ID, ISTHREATENED, ISEEP) VALUES ('1002', 'Mit bis zu 175cm Höhe größter flugfähiger Vogel. Vom australischen Brolgakranich durch den ausgedehnteren rothäutigen Gesichts- und Halsbereich unterschieden. Gräbt im Gegensatz zu diesem nicht nach Nahrung. Lauteste Stimme aller Kraniche.', 'Hat sein Verbreitungsgebiet im Verlauf der letzten Jahrzehnte auf den australischen Kontinent ausgedehnt. Dort behauptet er sich zunehmend gegen seinen kleineren Verwandten.', 'Indien, Südostasien, Nordaustralien', '1002', '0', '0');
...
INSERT INTO "BAER_TI"."TBLANIMALSPECIESDETAIL" (ID, CHARACTERISTICS, VITA, HABITAT, TBLANIMALSPECIES_ID, ISTHREATENED, ISEEP) VALUES ('2000', 'Bei einer Körpergröße von 60-75cm, einer Spannweite von 160-180cm und einem Gewicht bis über 4000g eine der größten Eulen überhaupt. Kennzeichnend sind die Federohren, die jedoch nicht zum Hören dienen.', 'Lange Zeit gebietsweise stark von der Ausrottung bedroht, hat sich der Bestand durch strengen Schutz und auswilderung zoogeborener Tiere in den letzten Jahrzehnten in Zentraleuropa erfreulich erholt. Monogame Lebensweise.', 'Eurasien', '2000', '0', '0');


-- Maguaristorch

INSERT INTO "BAER_TI"."TBLANIMALSYSTEM" (ID, PARENT_ID, TBLANIMALSYSTEMTYPE_ID, TRIVIALNAME, BINOMIALNAME) VALUES ('2002', '115', '6', 'Eigentliche Störche', 'Ciconia');
...
call baer_ti.insertAnimalImage(2000, 'Europäischer Uhu', 'ein Europäischer Uhu','7Europäischer Uhu.JPG');
